...
import {getSearchTableResults,deleteSearchTableResults,setCreatorTableId} from '../actions'


class ChartCreator_SearchTable extends Component {
...
export default connect(mapStateToProps)(ChartCreator_SearchTable)
